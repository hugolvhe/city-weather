...
function createIcon(name: string, src: string) {
...
function createElemList(name: string, content: string) {
...
function createTitle(content: string, size: number) {
...
function createCityInfo(data: Object) {
...
function createCurrentCondition(data: Object) {
...
function createDay(data: Object, i: number) {
...
function createForecastInfo(data: Object) {
...
function requestApi(event: Event) {
    event.preventDefault();
    const city: HTMLInputElement | null = document.querySelector('form input[name="city"]');
